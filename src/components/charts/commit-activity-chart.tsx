...
export default function CommitActivityChart({
  ...
  useEffect(() => {
    ...
    const commitsByAuthor: Record<string, Record<string, number>> = {};
    ...
    const lastCommitDate = new Date(
      sortedCommits[sortedCommits.length - 1]?.commit.author.date
    );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Évolution des commits au fil du temps avec tendance
        </CardDescription>
      </CardHeader>
      <CardContent>
