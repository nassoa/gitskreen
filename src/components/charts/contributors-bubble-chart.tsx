...
export default function ContributorsBubbleChart({ repoData }) {
  ...
  useEffect(() => {
    const fetchContributors = async () => {
      ...
      try {
        ...
        const response = await fetchWithAuth(`https://api.github.com/repos/${owner}/${repo}/stats/contributors`)
        ...
        if (contributors.length === 0) {
          ...
          const retryResponse = await fetchWithAuth(`https://api.github.com/repos/${owner}/${repo}/stats/contributors`)
      ...
      <CardHeader>
        ...
        <CardDescription>
          ...
          <span className="block text-xs text-muted-foreground mt-1">
            Taille des bulles = nombre de commits, X = première contribution, Y = semaines d&apos;activité
          </span>
        </CardDescription>
      </CardHeader>
      <CardContent>
